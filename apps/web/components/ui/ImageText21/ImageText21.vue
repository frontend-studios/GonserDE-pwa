<template>
  <div :class="['flex flex-col md:flex-row items-stretch', positionClass]">
    ...
    <div :class="['md:w-1/3', 'p-4', 'bg-gray-100', 'flex', 'items-center']">
...
import type { ImageText21Props, ImageDimensions } from '~/components/ui/ImageText21/types';

const viewport = useViewport();

const props = defineProps<ImageText21Props>();
